...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let Planning = Planning.init(entity: NSEntityDescription.entity(
            forEntityName: "Planning", in:managedContext)!,
            insertInto: managedContext)
        
        Planning.nomPlanning = jourCourant
        planning = Planning
    }
    ...
    @IBAction func recetteValidee(segue : UIStoryboardSegue) {
        ...
        // Question 8
        // Ajouter la recette courante au planning
        planning.addToEstCompose(recetteCourante)
        recetteCourante.addToCompose(planning)
        
        // Afficher la recette dans le planning
